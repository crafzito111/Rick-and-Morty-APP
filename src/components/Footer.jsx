      ...
      <div className="footer">
         <div className="este">
            <button className="btn-cssbuttons">
               ...
               <ul>
                  <li>
                     <a target="_blank" href="https://twitter.com/CarlosPrad2">
                        <svg
                           height="18"
                           width="18"
                           xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li>
                     <a target="_blank" href="https://www.linkedin.com/in/carlos-prado-0555b7236/">
                        <svg
                           xmlns="http://www.w3.org/2000/svg"
                           height="18"
                           width="18"
                  ...
                  <li>
                     <a target="_blank" href="https://github.com/crafzito111">
                        <svg
                           height="18"
                           width="18"
                           xmlns="http://www.w3.org/2000/svg"
